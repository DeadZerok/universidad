...
//importacion de Control
import Control.ControlUsuario;
import javax.swing.table.TableRowSorter;

public class RegistroUsuarios extends javax.swing.JPanel {

    ControlUsuario controlUsuarios = new ControlUsuario();
    ...
    private void initComponents() {
        ...
        btn_Ver_usuario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/participacion.png"))); // NOI18N
        ...
        Ver_usuario.add(btn_Ver_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 135, 33));

        panel_Regis_usuario.add(Ver_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(75, 350, 135, 33));
        ...
        box_Nombre_usuario.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                box_Nombre_usuarioKeyTyped(evt);
            }
        });
    ...
    private void btn_GuardarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_GuardarMousePressed
        ...
        String nombre = box_Nombre_usuario.getText();
        String apellido = box_Apellido_usuario.getText();
        long identificacion = Long.parseLong(box_Identificacion_usuario.getText());
        long telefono = Long.parseLong(box_telefono_usuario.getText());

        new ControlUsuario().RegistrarUsuario(nombre, apellido, identificacion, telefono);
        new ControlUsuario().LlenarTablaUsuario(new Usuario().table_usuarios);

    }//GEN-LAST:event_btn_GuardarMousePressed

    private void box_Nombre_usuarioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_box_Nombre_usuarioKeyTyped


    }//GEN-LAST:event_box_Nombre_usuarioKeyTyped
